    ...
    >
      <div className='group-hover bg-black-50/70 z-40 w-full h-full absolute transition-all duration-300'></div>
        ...
        <div className='flex items-center'>
          <Link href={link} target="_blank" className="inline-flex mr-4 items-center px-3 py-2 text-sm font-medium text-center text-white bg-green-50 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
            LIVE DEMO
